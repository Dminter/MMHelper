...
public class NotificationActionReceiver extends BroadcastReceiver {
    ...
    public static void showNotification(Context context, boolean isPaused) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setOngoing(!isPaused);
        if (isPaused) {
            builder.addAction(R.mipmap.ic_noti_action_resume, context.getString(R.string.noti_action_resume),
                    getPendingIntent(context, ACTION_RESUME));
        } else {
            builder.addAction(R.mipmap.ic_noti_action_pause,
                    context.getString(R.string.noti_action_pause),
                    getPendingIntent(context, ACTION_PAUSE));
        }

        builder.addAction(R.mipmap.ic_noti_action_stop,
